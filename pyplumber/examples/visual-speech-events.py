...
def main() -> None:
    ...
    nodes = [
        ...
        VisualSpeechGateNode({
            ...
            "score_mode": os.environ.get("AVP_VISUAL_SCORE_MODE", "legacy"),
            ...
            "oscillation_window_ms": float(os.environ.get("AVP_VISUAL_OSCILLATION_WINDOW_MS", "900")),
            "oscillation_min_detected_frames": int(os.environ.get("AVP_VISUAL_OSCILLATION_MIN_DETECTED_FRAMES", "10")),
            "oscillation_min_detected_ratio": float(os.environ.get("AVP_VISUAL_OSCILLATION_MIN_DETECTED_RATIO", "0.45")),
            "oscillation_min_h_range": float(os.environ.get("AVP_VISUAL_OSCILLATION_MIN_H_RANGE", "0.014")),
            "oscillation_min_direction_changes": int(os.environ.get("AVP_VISUAL_OSCILLATION_MIN_DIRECTION_CHANGES", "2")),
            "oscillation_min_derivative_sum": float(os.environ.get("AVP_VISUAL_OSCILLATION_MIN_DERIVATIVE_SUM", "0.035")),
            "oscillation_derivative_deadband": float(os.environ.get("AVP_VISUAL_OSCILLATION_DERIVATIVE_DEADBAND", "0.0018")),
