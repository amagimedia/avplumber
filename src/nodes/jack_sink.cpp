...
public:
  ...
  void prepare() {
    ...
    jack_client = jack_client_open("test_client", JackNoStartServer, &status);
    ...
    for (int i = 0; i < channels_count; i++) {
      jack_ports[i] = (jack_port_t *)malloc(sizeof(jack_port_t *));
