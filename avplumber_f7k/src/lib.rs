...
pub use node_api::{
    Blocking, BlockingIo, BlockingNode, EofAction, InputHandler, Io, NodeObjects, PollInput,
    PollIo, PollNode, Polling, SingleInput, SisoAdapter, SisoAsyncAdapter, SisoNode,
    SisoPollAdapter,
};
...
pub struct InstanceInner {
    ...
    pub(crate) media_vtables: Arc<Mutex<HashMap<AvpMediaType, AvpMediaVtable>>>,
    ...
    pub fn new() -> Self {
        ...
        Self {
            inner: Arc::new(InstanceInner {
                ...
                media_vtables: Arc::new(Mutex::new(HashMap::new())),
