...
void STrack::activate(byte_kalman::KalmanFilter &kalman_filter, int frame_id, int &next_track_id)
{
	this->kalman_filter = kalman_filter;
	this->track_id = ++next_track_id;
...
void STrack::re_activate(STrack &new_track, int frame_id, bool new_id, int *next_track_id)
{
