...
struct Object
{
	float x, y, w, h;  // top-left x, y, width, height
	int label;
	float prob;
	int detection_index;  // source detection index for mapping back
};
...
public:
	...
	const vector<STrack>& get_lost_stracks() const { return lost_stracks; }
