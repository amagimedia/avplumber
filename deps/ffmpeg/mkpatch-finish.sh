...
# write 0011-avformat-libmxl-demuxer-muxer.patch to /out.
#
# $1 = commit hash of "base after 0001-0010 applied". Passed by
#      mkpatch-0011-mxl.sh after a successful cherry-pick, or by the user
...
OUT_DIR="${OUT_DIR:-/out}"
OUT_FILE="$OUT_DIR/0011-avformat-libmxl-demuxer-muxer.patch"
...
MSG_FILE="$(mktemp)"
{
    ...
    printf 'series 0001-0010, with the configure hunks re-anchored so the\n'
