...
-   `drop_alpha` (bool, default `false`) - report the output CUDA surface as `RGB0` instead of `RGBA`; the fourth channel remains padding, allowing alpha-less consumers such as NVENC
