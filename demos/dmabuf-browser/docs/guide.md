...
[Quick start and current measurements](../README.md)
...
removed most browser runtime cost. The stage comparison was subsequently repeated at fixed clocks;
see the [current measurements](../README.md#measured-runtime). The older
automatic-clock isolation percentages are unsuitable for attributing the cost
