...
$(eval $(call ptx_kernel,$(SRCDIR)/nodes/neural_net/sport_specific/scene_diff_cuda.cu,avpl_scene_diff_ptx,objs/src/nodes/neural_net/sport_specific/scene_diff_cuda.o))
